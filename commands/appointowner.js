...
module.exports = {
  ...
  data: new SlashCommandBuilder()
    .setName('appointowner')
    .setDescription('Appoint user the owner of a team')
  ...
  async execute(interaction) {
    ...
    if (!clubs.includes(interaction.options.getRole('club').id)) {
      ...
      userx.roles.add(interaction.options.getRole('club'))
      userx.roles.add("1149478114397786192")
